  ...
  <Layout>
    ...
    <div className="SideFormAndContent">
      ...
      <Text type="paragraph">
        ...
        Medikamente. Patienten gehen zunächst in Vorleistung und erhalten das
        Geld für Kassenleistungen anschliessend erstattet.
      </Text>
      <Text type="subtitle">
        Gleiche Leistung, unterschiedlich hohe Prämien
      </Text>
      <Text type="paragraph">
        Welche Leistungen die Grundversicherung abdeckt, regelt das KVG. Die
        Höhe der Prämien bestimmt dagegen jede Krankenkasse selbst. Die
        Beitragshöhe hängt von vielen verschiedenen Faktoren ab und
        unterscheidet sich zum Beispiel je nach Kanton und Prämienregion. Alter,
        Einkommen und Familienstand beeinflussen die Prämienhöhe ebenfalls.
      </Text>
      <Text type="paragraph">
        Jedes Jahr im Herbst legen die Krankenkassen die Prämien für das
        kommende Jahr fest. Das Bundesamt für Gesundheit (BAG) muss die Prämien
        bestätigen und veröffentlicht die neuen Beiträge bis zum 24. September.
        Zu Beginn 2020 sind die Krankenkassenprämien wieder einmal gestiegen. Im
      ...
      <Text type="paragraph">
        Für das kommende Jahr werden abermals steigende Prämien erwartet. Bis
        Ende Oktober muss Ihre Krankenversicherung Sie über die neue
        Beitragshöhe informieren. Spätestens dann lohnt es sich, den
        Krankenkassenvergleich zu machen und nach einer günstigeren Krankenkasse
        zu suchen. Mit einem Krankenkassenwechsel zu einem günstigeren Anbieter
        können Sie mehrere Hundert oder sogar Tausend Schweizer Franken sparen -
        bei gleicher Leistung.
      </Text>
      <Text type="paragraph">
        Hat Ihre Krankenkasse eine Prämienerhöhung angekündigt, können Sie bis
        zum 30. November des Jahres kündigen. Die Kündigung tritt dann zum 31.
        Dezember in Kraft, ab dem 1. Januar gilt Ihr neuer Krankenkassenvertrag.
        Mit unserem Krankenkassenvergleich finden Sie heraus, ob sich der
