    ...
    <div>
      ...
      <div style={{ width: "70%" }}>
        ...
        <Text type="paragraph">
          ...
          Zusatzversicherungen, die zu Ihren Bedürfnissen passen? Wir beraten
          Sie gerne kostenlos und unverbindlich. Füllen Sie einfach das unten
          stehende Kontaktformular aus und wir werden uns umgehend bei Ihnen
          melden.
        </Text>
        <ContactForm />
        <Text type="paragraph">
        ...
        <Text type="paragraph">
          Damit wir direkt Kontakt zu Ihnen aufnehmen können, bitten wir Sie,
          alle persönlichen Angaben im Kontaktformular korrekt und vollständig
          auszufüllen. Für genaue Auskünfte geben Sie bitte auch Ihre aktuelle
          Krankenkasse an. Beschreiben Sie Ihr Anliegen so konkret und
          detailliert wie möglich. So können wir gezielt auf Ihre persönlichen
          Bedürfnisse eingehen und Ihnen eine individuell abgestimmte Empfehlung
          aussprechen.
        </Text>
        <Text type="paragraph">
          Je nach Auslastung erhalten Sie innerhalb weniger Stunden eine
          Antwort. Holen Sie gleich Auskünfte zu Ihrer Krankenkasse ein und
          erfahren Sie, wie Sie Prämien sparen können. Informieren Sie sich über
          alternative Modelle der Grundversicherung und sinnvolle
        ...
        <Text type="paragraph">
          ...
          Kontaktdaten und Ihre Telefonnummer anzugeben, damit wir uns direkt
